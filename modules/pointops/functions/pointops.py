...
try:
    ...
    pointops_cuda = load(
        'pointops_cuda',
        [
            f'{pointops_cuda_src}/pointops_api.cpp',
            f'{pointops_cuda_src}/ballquery/ballquery_cuda.cpp',
            f'{pointops_cuda_src}/ballquery/ballquery_cuda_kernel.cu',
            f'{pointops_cuda_src}/knnquery/knnquery_cuda.cpp',
            f'{pointops_cuda_src}/knnquery/knnquery_cuda_kernel.cu',
            f'{pointops_cuda_src}/knnquery_heap/knnquery_heap_cuda.cpp',
            f'{pointops_cuda_src}/knnquery_heap/knnquery_heap_cuda_kernel.cu',
            f'{pointops_cuda_src}/grouping/grouping_cuda.cpp',
            f'{pointops_cuda_src}/grouping/grouping_cuda_kernel.cu',
            f'{pointops_cuda_src}/grouping_int/grouping_int_cuda.cpp',
            f'{pointops_cuda_src}/grouping_int/grouping_int_cuda_kernel.cu',
            f'{pointops_cuda_src}/interpolation/interpolation_cuda.cpp',
            f'{pointops_cuda_src}/interpolation/interpolation_cuda_kernel.cu',
            f'{pointops_cuda_src}/sampling/sampling_cuda.cpp',
            f'{pointops_cuda_src}/sampling/sampling_cuda_kernel.cu',
        ],
